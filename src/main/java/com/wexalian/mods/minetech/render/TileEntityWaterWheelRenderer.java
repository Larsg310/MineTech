...
public class TileEntityWaterWheelRenderer extends TileEntityRenderer<TileEntityWaterWheel>
{
    @SuppressWarnings("Duplicates")
    @Override
    public void render(TileEntityWaterWheel tile, double x, double y, double z, float partialTicks, int destroyStage)
    {
        ...
        float scale = (float) Math.sqrt(2F/*tile.getScale()*/);
