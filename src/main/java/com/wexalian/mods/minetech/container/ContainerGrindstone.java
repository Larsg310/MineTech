...
public class ContainerGrindstone extends Container
{
    ...
    public ContainerGrindstone(TileEntityGrindstone tileEntity, InventoryPlayer playerInventory)
    {
        tile = tileEntity;
        // @formatter:off
        addSlot(new SlotItemHandler(tile.getInventory(), 0, GRINDSTONE_INV_X,                 GRINDSTONE_INV_Y                ));
        addSlot(new SlotItemHandler(tile.getInventory(), 1, GRINDSTONE_INV_X + SLOT_SIZE,     GRINDSTONE_INV_Y                ));
        addSlot(new SlotItemHandler(tile.getInventory(), 2, GRINDSTONE_INV_X + SLOT_SIZE * 2, GRINDSTONE_INV_Y                ));
        addSlot(new SlotItemHandler(tile.getInventory(), 3, GRINDSTONE_INV_X,                 GRINDSTONE_INV_Y + SLOT_SIZE    ));
        addSlot(new SlotItemHandler(tile.getInventory(), 4, GRINDSTONE_INV_X + SLOT_SIZE * 2, GRINDSTONE_INV_Y + SLOT_SIZE    ));
        addSlot(new SlotItemHandler(tile.getInventory(), 5, GRINDSTONE_INV_X,                 GRINDSTONE_INV_Y + SLOT_SIZE * 2));
        addSlot(new SlotItemHandler(tile.getInventory(), 6, GRINDSTONE_INV_X + SLOT_SIZE,     GRINDSTONE_INV_Y + SLOT_SIZE * 2));
        addSlot(new SlotItemHandler(tile.getInventory(), 7, GRINDSTONE_INV_X + SLOT_SIZE * 2, GRINDSTONE_INV_Y + SLOT_SIZE * 2));
        // @formatter:on
        ...
        for (int y = 0; y < 3; y++)
        {
            for (int x = 0; x < 9; x++)
            {
                addSlot(new Slot(playerInventory, x + y * 9 + 9, PLAYER_INV_X + x * SLOT_SIZE, PLAYER_INV_Y + y * SLOT_SIZE));
            }
        }
        
        for (int x = 0; x < 9; x++)
        {
            addSlot(new Slot(playerInventory, x, PLAYER_HOTBAR_X + x * SLOT_SIZE, PLAYER_HOTBAR_Y));
        }
    }
