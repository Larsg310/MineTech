...
public class TileKineticTest extends TileEntity
{
    ...
    {
        top.deserializeNBT(pkt.getNbtCompound().getCompoundTag("top"));
        bottom.deserializeNBT(pkt.getNbtCompound().getCompoundTag("bottom"));
    }
